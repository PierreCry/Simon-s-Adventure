...
img=can.create_image(1825,475,image=o02)
o03=PhotoImage(file='Objets/Trinité jaune.gif')
img=can.create_image(1475,525,image=o03)
o04=PhotoImage(file='Objets/Casque.gif')
img=can.create_image(575,325,image=o04)
o05=PhotoImage(file='Objets/Bouclier.gif')
img=can.create_image(1025,475,image=o05)
